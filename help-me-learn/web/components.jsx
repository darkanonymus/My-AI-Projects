...
function Icon({ name, size = 18 }) {
  ...
  const paths = {
    ...
    eyeoff:  <><path d="M9.9 4.6A11 11 0 0 1 12 4.5c6.5 0 10 7.5 10 7.5a19 19 0 0 1-3.2 4M6.2 6.2A19 19 0 0 0 2 12s3.5 7.5 10 7.5a11 11 0 0 0 3.9-.7"/><path d="M3 3l18 18"/></>,
