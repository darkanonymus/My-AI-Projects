...
function LibraryTab({ chapters, onOpen, onToggleMastered, onDelete, onDownload, onNew }) {
  ...
  return (
    <div>
      ...
      {/* stats banner */}
      <div className="card" style={{ padding: "var(--space-5) var(--space-6)", marginBottom: "var(--space-6)", display: "flex", gap: "var(--space-6)", alignItems: "center", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: "var(--space-7)", flexWrap: "wrap", flex: 1 }}>
